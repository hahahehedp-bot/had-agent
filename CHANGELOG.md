...
## [v13.3.1] - 2026-05-08
### Fixed
- **Message Guard**: 어떤 긴 문장이라도 말풍선을 넘지 못하도록 강제 줄 바꿈(`overflow-wrap`) 적용.
- **Bottom Shield**: 하단 여백이 무시되는 현상을 해결하기 위해 물리적인 투명 보호막(Bottom Shield) 배치.
- **Horizontal Scroll Removal**: 가로 스크롤 발생 요인을 차단하여 모바일 가시성 확보.
