...
## [v13.4.0] - 2026-05-08
### Fixed
- **Gemini-Style AI Replies**: AI 답변의 말풍선 배경을 제거하고 너비를 100% 사용하여 제미나이와 같은 개방형 UI 구현.
- **Bottom-Stick Input**: 입력창 하단 보호막을 최소화하여 화면 최하단에 최대한 밀착 배치.
- **Full-Width Chat**: 메시지 영역의 좌우 여백을 줄여 채팅 탭 공간을 최대한 넓게 활용.
