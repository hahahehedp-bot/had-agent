...
## [v13.2.8] - 2026-05-08
### Fixed
- **Greeting Recovery**: 인사말 렌더링 로직을 안전한 방식으로 복구하여 비서의 첫인사 보장.
- **Layout Stability**: `dvh` 단위 대신 표준 `100%`를 사용하여 특정 모바일 브라우저의 입력창 가림 현상 수정.
- **Header Padding**: 상단 헤더 여백을 다시 한번 정밀 조정하여 대화 영역과 조화롭게 배치.
