...
## [v13.3.2] - 2026-05-08
### Fixed
- **Fighter-Jet Send Button**: 너무 비대해진 전송 버튼을 날렵한 사이즈(34px)로 축소 및 고정.
- **Welcome Message Wrap**: 알고리즘 인사말이 말풍선을 탈출하지 않도록 렌더링 로직 및 줄 바꿈 규칙 수정.
- **Top Shield**: 첫 대화가 상단 메뉴에 너무 바짝 붙지 않도록 물리적인 '천장 보호막' 추가.
