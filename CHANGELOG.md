...
## [v13.3.0] - 2026-05-08
### Fixed
- **UI Aesthetics**: 전송 버튼 찌그러짐 현상 수정 및 말풍선 스타일(글자 넘침 등) 최종 보강.
- **Markdown Rendering**: 인사말 마크다운 엔진 연결 오류 수정 및 렌더링 안정화.
- **Golden Ratio Padding**: 하단 여백 축소(8px) 및 상단 여백 추가로 모바일 최적 비율 구현.
