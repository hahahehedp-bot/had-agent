...
## [v13.4.1] - 2026-05-08
### Fixed
- **Integrated Input Bar**: 전송 버튼을 입력창 우측 안쪽으로 통합하여 순정 제미나이 스타일 구현 및 공간 최적화.
- **Zero-Bubble Design**: AI 및 사용자 메시지의 모든 말풍선 배경을 제거하고 텍스트 중심의 개방형 UI로 전환.
- **Ultra-Bottom Docking**: 입력창 하단 여백을 제거하고 시스템 세이프 에어리어만 적용하여 바닥에 완전 밀착.
