...
## [v13.2.2] - 2026-05-08
### Fixed
- **Viewport Displacement**: 모바일 브라우저 주소창 변화에 따른 화면 밀림 현상 수정 (`100dvh` 적용).
- **Body Scroll Lock**: 서랍 오픈 시 배경 스크롤을 차단하여 레이아웃 안정성 확보.
- **Scroll Reset**: 모듈 전환 시 서랍 내부 스크롤을 최상단으로 강제 초기화.
